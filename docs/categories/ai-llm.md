...
- **⭐ Stars**: `266,984` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 超高人气（★ 266,984）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)
- **⭐ Stars**: `248,760` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 248,760）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 3. [langgenius/dify](https://github.com/langgenius/dify)
- **⭐ Stars**: `157,128` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 超高人气（★ 139,683）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 5. [farion1231/cc-switch](https://github.com/farion1231/cc-switch)
- **⭐ Stars**: `136,526` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Rust`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 130,435）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 7. [TauricResearch/TradingAgents](https://github.com/TauricResearch/TradingAgents)
- **⭐ Stars**: `108,493` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 108,493）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 8. [lobehub/lobehub](https://github.com/lobehub/lobehub)
- **⭐ Stars**: `82,807` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 82,807）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 9. [666ghj/MiroFish](https://github.com/666ghj/MiroFish)
- **⭐ Stars**: `74,520` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 74,520）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 10. [tt-a1i/archify](https://github.com/tt-a1i/archify)
- **⭐ Stars**: `71,279` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 65,609）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 12. [BerriAI/litellm](https://github.com/BerriAI/litellm)
- **⭐ Stars**: `59,578` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 59,578）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 13. [CherryHQ/cherry-studio](https://github.com/CherryHQ/cherry-studio)
- **⭐ Stars**: `52,133` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 52,133）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 14. [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet)
- **⭐ Stars**: `40,988` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 超高人气（★ 40,988）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 15. [alibaba/nacos](https://github.com/alibaba/nacos)
- **⭐ Stars**: `33,420` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Java`
...
- **✨ 核心功能与亮点**:
  ...
  - 容器化就绪：内置 Dockerfile 与容器编排模板，方便一键部署上线与集群扩容
  - 超高人气（★ 33,420）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 16. [hsliuping/TradingAgents-CN](https://github.com/hsliuping/TradingAgents-CN)
- **⭐ Stars**: `31,965` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
- **🏷️ 标签**: `Python` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 31,965）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 17. [e2b-dev/awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents)
- **⭐ Stars**: `30,153` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Unknown`
...
- **✨ 核心功能与亮点**:
  ...
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 30,153）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **⭐ Stars**: `23,078` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Go`
...
- **⭐ Stars**: `22,557` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
- **🏷️ 标签**: `Python` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 22,557）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 21. [getpaseo/paseo](https://github.com/getpaseo/paseo)
- **⭐ Stars**: `18,486` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 18,486）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 22. [Portkey-AI/gateway](https://github.com/Portkey-AI/gateway)
- **⭐ Stars**: `13,079` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 13,079）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 23. [codexu/note-gen](https://github.com/codexu/note-gen)
- **⭐ Stars**: `12,835` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 12,835）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **⭐ Stars**: `4,955` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 2,719）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 28. [phodal/routa](https://github.com/phodal/routa)
- **⭐ Stars**: `1,822` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **⭐ Stars**: `1,318` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Go`
- **🏷️ 标签**: `Go` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 极致性能：使用 Go 原生编写，单二进制分发，内存占用低且启动迅速
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 1,318）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 30. [ddcat-ai/open-ai-canvas](https://github.com/ddcat-ai/open-ai-canvas)
- **⭐ Stars**: `1,010` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
- **🏷️ 标签**: `TypeScript` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 1,010）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 31. [friuns2/codex-mobile](https://github.com/friuns2/codex-mobile)
- **⭐ Stars**: `941` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 精选实用工具（★ 941）：针对特定垂直场景设计，解决痛点需求，小巧精悍


## 2. 💬 大模型应用与客户端 (20 个项目)

### 1. [openclaw/openclaw](https://github.com/openclaw/openclaw)
- **⭐ Stars**: `390,437` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 390,437）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [router-for-me/CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI)
- **⭐ Stars**: `53,145` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Go`
...
- **✨ 核心功能与亮点**:
  ...
  - 极致性能：使用 Go 原生编写，单二进制分发，内存占用低且启动迅速
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 53,145）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 3. [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api)
- **⭐ Stars**: `42,628` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Go`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 29,489）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 5. [mlc-ai/web-llm](https://github.com/mlc-ai/web-llm)
- **⭐ Stars**: `19,187` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 19,187）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **⭐ Stars**: `10,336` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 10,336）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 JavaScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 5,676）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 9. [knownsec/aipyapp](https://github.com/knownsec/aipyapp)
- **⭐ Stars**: `4,027` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `HTML`
- **🏷️ 标签**: `HTML`
...
- **✨ 核心功能与亮点**:
  ...
  - 热门高星（★ 1,789）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃
...
- **⭐ Stars**: `1,275` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `C`
- **🏷️ 标签**: `C`
...
- **✨ 核心功能与亮点**:
  ...
  - 极致性能：使用 C 原生编写，单二进制分发，内存占用低且启动迅速
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 1,275）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃
...
- **⭐ Stars**: `37,020` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 JavaScript 打造，代码规范健壮，支持热重载与模块化组装
  - 标准化 API 支持：提供完善的 RESTful / gRPC 接口与清晰的接口文档规范
  - 超高人气（★ 37,020）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [JaidedAI/EasyOCR](https://github.com/JaidedAI/EasyOCR)
- **⭐ Stars**: `30,025` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 30,025）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **⭐ Stars**: `12,547` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 12,547）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **⭐ Stars**: `6,362` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 6,362）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃
...
- **⭐ Stars**: `125,549` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 125,549）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book)
- **⭐ Stars**: `50,816` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 50,816）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 3. [HBAI-Ltd/Toonflow-app](https://github.com/HBAI-Ltd/Toonflow-app)
- **⭐ Stars**: `16,010` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 16,010）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 4. [chatfire-AI/huobao-drama](https://github.com/chatfire-AI/huobao-drama)
- **⭐ Stars**: `15,513` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `Vue`
- **🏷️ 标签**: `Vue`
...
- **✨ 核心功能与亮点**:
  ...
  - 技术栈友好：灵活适配多种技术环境，支持容器化与多平台部署
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 12,678）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 6. [eternityspring/shuohao-skills](https://github.com/eternityspring/shuohao-skills)
- **⭐ Stars**: `3,798` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `JavaScript`
- **🏷️ 标签**: `JavaScript` `LLM`
...
- **⭐ Stars**: `23,763` | **二级分类**: 🎙️ `语音识别与音频处理` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 23,763）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [kaldi-asr/kaldi](https://github.com/kaldi-asr/kaldi)
- **⭐ Stars**: `15,493` | **二级分类**: 🎙️ `语音识别与音频处理` | **语言**: `Shell`
...
- **✨ 核心功能与亮点**:
  ...
  - 脚本化一键执行：跨环境无缝适配，免复杂安装配置，支持一键自动化脚本部署
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 15,493）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 3. [modelscope/modelscope](https://github.com/modelscope/modelscope)
- **⭐ Stars**: `9,154` | **二级分类**: 🎙️ `语音识别与音频处理` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 9,154）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃
