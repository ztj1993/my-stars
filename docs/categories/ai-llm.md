...
> 本文档收录了 `ztj1993` 在 **AI 与大模型** 领域的精选 Star 项目，共划分 **5** 个二级细分子分类。

[← 返回知识库总览](../../README.md)

## 📑 本专题二级分类导航

- [🤖 **智能体与工作流** (31 个项目)](#1-智能体与工作流)
- [💬 **大模型应用与客户端** (20 个项目)](#2-大模型应用与客户端)
- [🧠 **模型微调与底层工具** (8 个项目)](#3-模型微调与底层工具)
- [🎬 **AI 生成与短剧/多模态** (6 个项目)](#4-AI 生成与短剧/多模态)
- [🎙️ **语音识别与音频处理** (3 个项目)](#5-语音识别与音频处理)
...
- **⭐ Stars**: `265,519` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 超高人气（★ 265,519）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)
- **⭐ Stars**: `248,146` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 248,146）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 3. [langgenius/dify](https://github.com/langgenius/dify)
- **⭐ Stars**: `156,900` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 超高人气（★ 139,462）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 5. [farion1231/cc-switch](https://github.com/farion1231/cc-switch)
- **⭐ Stars**: `134,702` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Rust`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 129,917）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 7. [TauricResearch/TradingAgents](https://github.com/TauricResearch/TradingAgents)
- **⭐ Stars**: `108,174` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 108,174）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 8. [lobehub/lobehub](https://github.com/lobehub/lobehub)
- **⭐ Stars**: `82,767` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 82,767）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 9. [666ghj/MiroFish](https://github.com/666ghj/MiroFish)
- **⭐ Stars**: `74,316` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 74,316）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 10. [tt-a1i/archify](https://github.com/tt-a1i/archify)
- **⭐ Stars**: `70,028` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 65,513）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 12. [BerriAI/litellm](https://github.com/BerriAI/litellm)
- **⭐ Stars**: `59,429` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 59,429）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 13. [CherryHQ/cherry-studio](https://github.com/CherryHQ/cherry-studio)
- **⭐ Stars**: `52,089` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 52,089）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 14. [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet)
- **⭐ Stars**: `40,976` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 超高人气（★ 40,976）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 15. [alibaba/nacos](https://github.com/alibaba/nacos)
- **⭐ Stars**: `33,413` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Java`
...
- **✨ 核心功能与亮点**:
  ...
  - 容器化就绪：内置 Dockerfile 与容器编排模板，方便一键部署上线与集群扩容
  - 超高人气（★ 33,413）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 16. [hsliuping/TradingAgents-CN](https://github.com/hsliuping/TradingAgents-CN)
- **⭐ Stars**: `31,948` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
- **🏷️ 标签**: `Python` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 31,948）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 17. [e2b-dev/awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents)
- **⭐ Stars**: `30,126` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Unknown`
...
- **✨ 核心功能与亮点**:
  ...
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 30,126）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 18. [RooCodeInc/Roo-Code](https://github.com/RooCodeInc/Roo-Code)
- **⭐ Stars**: `24,299` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
- **🏷️ 标签**: `TypeScript` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 24,299）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 19. [micro/go-micro](https://github.com/micro/go-micro)
- **⭐ Stars**: `23,074` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Go`
- **🏷️ 标签**: `Go` `ai` `ai-agents` `distributed-systems` `golang` `mcp`
- **📝 中文介绍**: Go agent harness and service 框架。
- **✨ 核心功能与亮点**:
  - 【智能体与工作流】专精领域：专注解决 智能体与工作流 场景下的核心需求与工程实践
  - 极致性能：使用 Go 原生编写，单二进制分发，内存占用低且启动迅速
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 23,074）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 20. [HKUDS/AI-Trader](https://github.com/HKUDS/AI-Trader)
- **⭐ Stars**: `22,527` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
- **🏷️ 标签**: `Python` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 22,527）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 21. [getpaseo/paseo](https://github.com/getpaseo/paseo)
- **⭐ Stars**: `18,111` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 18,111）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 22. [Portkey-AI/gateway](https://github.com/Portkey-AI/gateway)
- **⭐ Stars**: `13,066` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 13,066）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 23. [codexu/note-gen](https://github.com/codexu/note-gen)
- **⭐ Stars**: `12,830` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 12,830）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 24. [Justson/AgentWeb](https://github.com/Justson/AgentWeb)
- **⭐ Stars**: `9,430` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Java`
...
- **✨ 核心功能与亮点**:
  ...
  - 企业级稳健架构：基于 Java 企业级生态，具备成熟的依赖生态与严谨的类型系统
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 9,430）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 25. [Helicone/helicone](https://github.com/Helicone/helicone)
- **⭐ Stars**: `6,176` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 热门高星（★ 6,176）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 26. [ag2ai/ag2](https://github.com/ag2ai/ag2)
- **⭐ Stars**: `4,953` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 热门高星（★ 4,953）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 27. [virtio-win/kvm-guest-drivers-windows](https://github.com/virtio-win/kvm-guest-drivers-windows)
- **⭐ Stars**: `2,718` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `C`
- **🏷️ 标签**: `C` `c-plus-plus` `drivers` `guest` `guest-agent` `kernel-driver`
...
### 28. [phodal/routa](https://github.com/phodal/routa)
- **⭐ Stars**: `1,820` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
- **🏷️ 标签**: `TypeScript` `LLM` `GUI/WebUI`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 1,820）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 29. [run-bigpig/jcp](https://github.com/run-bigpig/jcp)
...
### 30. [ddcat-ai/open-ai-canvas](https://github.com/ddcat-ai/open-ai-canvas)
- **⭐ Stars**: `983` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
- **🏷️ 标签**: `TypeScript` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 精选实用工具（★ 983）：针对特定垂直场景设计，解决痛点需求，小巧精悍

### 31. [friuns2/codex-mobile](https://github.com/friuns2/codex-mobile)
- **⭐ Stars**: `935` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 精选实用工具（★ 935）：针对特定垂直场景设计，解决痛点需求，小巧精悍


## 2. 💬 大模型应用与客户端 (20 个项目)

### 1. [openclaw/openclaw](https://github.com/openclaw/openclaw)
- **⭐ Stars**: `390,270` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 390,270）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [router-for-me/CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI)
- **⭐ Stars**: `52,898` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Go`
...
- **✨ 核心功能与亮点**:
  ...
  - 极致性能：使用 Go 原生编写，单二进制分发，内存占用低且启动迅速
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 52,898）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 3. [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api)
- **⭐ Stars**: `42,435` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Go`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 29,490）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 5. [mlc-ai/web-llm](https://github.com/mlc-ai/web-llm)
- **⭐ Stars**: `19,162` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `TypeScript`
...
### 8. [zxlie/FeHelper](https://github.com/zxlie/FeHelper)
- **⭐ Stars**: `5,673` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `JavaScript`
- **🏷️ 标签**: `JavaScript` `chatgpt` `chrome-extension` `code-beautify` `code-compress` `color-transfer`
...
- **⭐ Stars**: `4,025` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `HTML`
- **🏷️ 标签**: `HTML`
...
### 10. [dreamfactorysoftware/dreamfactory](https://github.com/dreamfactorysoftware/dreamfactory)
- **⭐ Stars**: `1,788` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Shell`
- **🏷️ 标签**: `Shell` `api` `api-generation` `api-generator` `automatic-api` `dreamfactory`
...
### 11. [WongSaang/chatgpt-ui](https://github.com/WongSaang/chatgpt-ui)
- **⭐ Stars**: `1,625` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Vue`
- **🏷️ 标签**: `Vue` `chatgpt` `chatgpt-client` `chatgpt-web` `django` `docker`
...
### 12. [ztane/python-Levenshtein](https://github.com/ztane/python-Levenshtein)
- **⭐ Stars**: `1,274` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `C`
- **🏷️ 标签**: `C`
...
### 13. [aio-libs/aiomonitor](https://github.com/aio-libs/aiomonitor)
- **⭐ Stars**: `777` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Python`
- **🏷️ 标签**: `Python` `async-await` `asyncio` `mypy` `uvloop`
...
### 14. [WongSaang/chatgpt-ui-server](https://github.com/WongSaang/chatgpt-ui-server)
- **⭐ Stars**: `314` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Python`
- **🏷️ 标签**: `Python` `chatgpt` `django` `LLM`
...
### 15. [paxan/python-dateutil](https://github.com/paxan/python-dateutil)
...
### 16. [dukn/Captcha-recognition-Keras](https://github.com/dukn/Captcha-recognition-Keras)
- **⭐ Stars**: `31` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `PHP`
- **🏷️ 标签**: `PHP` `captcha-recognition` `deep-learning` `image-processing` `keras`
...
### 17. [techjoomla/TJ-Notifications](https://github.com/techjoomla/TJ-Notifications)
- **⭐ Stars**: `5` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `PHP`
- **🏷️ 标签**: `PHP`
...
### 18. [286555452/air724ug-forwarder](https://github.com/286555452/air724ug-forwarder)
- **⭐ Stars**: `3` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Lua`
- **🏷️ 标签**: `Lua`
...
### 19. [eavan5/air780e-forwarder](https://github.com/eavan5/air780e-forwarder)
- **⭐ Stars**: `1` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Lua`
- **🏷️ 标签**: `Lua`
...
### 20. [tanlanghai/air780e](https://github.com/tanlanghai/air780e)
- **⭐ Stars**: `1` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Lua`
- **🏷️ 标签**: `Lua`
...
- **⭐ Stars**: `36,991` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 JavaScript 打造，代码规范健壮，支持热重载与模块化组装
  - 标准化 API 支持：提供完善的 RESTful / gRPC 接口与清晰的接口文档规范
  - 超高人气（★ 36,991）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [JaidedAI/EasyOCR](https://github.com/JaidedAI/EasyOCR)
- **⭐ Stars**: `30,023` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 12,546）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 5. [artidoro/qlora](https://github.com/artidoro/qlora)
- **⭐ Stars**: `11,021` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `Jupyter Notebook`
...
- **✨ 核心功能与亮点**:
  ...
  - 技术栈友好：灵活适配多种技术环境，支持容器化与多平台部署
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 11,021）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 6. [mindee/doctr](https://github.com/mindee/doctr)
- **⭐ Stars**: `6,361` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `Python`
- **🏷️ 标签**: `Python` `deep-learning` `document-recognition` `ocr` `optical-character-recognition` `pytorch`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 6,361）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 7. [APIParkLab/APIPark](https://github.com/APIParkLab/APIPark)
- **⭐ Stars**: `1,817` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `TypeScript`
- **🏷️ 标签**: `TypeScript` `ai` `ai-gateway` `api` `api-gateway` `api-platform`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 标准化 API 支持：提供完善的 RESTful / gRPC 接口与清晰的接口文档规范
  - 热门高星（★ 1,817）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 8. [kerlomz/captcha_platform](https://github.com/kerlomz/captcha_platform)
- **⭐ Stars**: `678` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `Python`
- **🏷️ 标签**: `Python` `captcha` `ocr` `tensorflow` `verification-code`
...
- **⭐ Stars**: `125,197` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 125,197）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book)
- **⭐ Stars**: `50,140` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 50,140）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 3. [HBAI-Ltd/Toonflow-app](https://github.com/HBAI-Ltd/Toonflow-app)
- **⭐ Stars**: `15,917` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `TypeScript`
- **🏷️ 标签**: `TypeScript` `ai` `ai-content-creation` `ai-tool` `ai-video-generation` `automation`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 15,917）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 4. [chatfire-AI/huobao-drama](https://github.com/chatfire-AI/huobao-drama)
- **⭐ Stars**: `15,443` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `Vue`
- **🏷️ 标签**: `Vue`
...
- **✨ 核心功能与亮点**:
  ...
  - 技术栈友好：灵活适配多种技术环境，支持容器化与多平台部署
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 12,668）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 6. [eternityspring/shuohao-skills](https://github.com/eternityspring/shuohao-skills)
- **⭐ Stars**: `3,708` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `JavaScript`
- **🏷️ 标签**: `JavaScript` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 JavaScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 3,708）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃


## 5. 🎙️ 语音识别与音频处理 (3 个项目)

### 1. [QwenAudio/CosyVoice](https://github.com/QwenAudio/CosyVoice)
- **⭐ Stars**: `23,735` | **二级分类**: 🎙️ `语音识别与音频处理` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 23,735）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [kaldi-asr/kaldi](https://github.com/kaldi-asr/kaldi)
- **⭐ Stars**: `15,490` | **二级分类**: 🎙️ `语音识别与音频处理` | **语言**: `Shell`
...
- **✨ 核心功能与亮点**:
  ...
  - 脚本化一键执行：跨环境无缝适配，免复杂安装配置，支持一键自动化脚本部署
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 15,490）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 3. [modelscope/modelscope](https://github.com/modelscope/modelscope)
- **⭐ Stars**: `9,148` | **二级分类**: 🎙️ `语音识别与音频处理` | **语言**: `Python`
- **🏷️ 标签**: `Python` `cv` `deep-learning` `machine-learning` `multi-modal` `nlp`
