...
- **⭐ Stars**: `266,233` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 超高人气（★ 266,233）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)
- **⭐ Stars**: `248,442` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 248,442）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 3. [langgenius/dify](https://github.com/langgenius/dify)
- **⭐ Stars**: `157,016` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 超高人气（★ 139,576）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 5. [farion1231/cc-switch](https://github.com/farion1231/cc-switch)
- **⭐ Stars**: `135,821` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Rust`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 130,177）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 7. [TauricResearch/TradingAgents](https://github.com/TauricResearch/TradingAgents)
- **⭐ Stars**: `108,336` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 108,336）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 8. [lobehub/lobehub](https://github.com/lobehub/lobehub)
- **⭐ Stars**: `82,793` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 82,793）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 9. [666ghj/MiroFish](https://github.com/666ghj/MiroFish)
- **⭐ Stars**: `74,408` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 74,408）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 10. [tt-a1i/archify](https://github.com/tt-a1i/archify)
- **⭐ Stars**: `70,686` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 65,543）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 12. [BerriAI/litellm](https://github.com/BerriAI/litellm)
- **⭐ Stars**: `59,507` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 59,507）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 13. [CherryHQ/cherry-studio](https://github.com/CherryHQ/cherry-studio)
- **⭐ Stars**: `52,121` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 52,121）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 14. [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet)
- **⭐ Stars**: `40,984` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 超高人气（★ 40,984）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 15. [alibaba/nacos](https://github.com/alibaba/nacos)
- **⭐ Stars**: `33,417` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Java`
...
- **✨ 核心功能与亮点**:
  ...
  - 容器化就绪：内置 Dockerfile 与容器编排模板，方便一键部署上线与集群扩容
  - 超高人气（★ 33,417）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 16. [hsliuping/TradingAgents-CN](https://github.com/hsliuping/TradingAgents-CN)
- **⭐ Stars**: `31,958` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
- **🏷️ 标签**: `Python` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 31,958）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 17. [e2b-dev/awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents)
- **⭐ Stars**: `30,137` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Unknown`
...
- **✨ 核心功能与亮点**:
  ...
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 30,137）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 18. [RooCodeInc/Roo-Code](https://github.com/RooCodeInc/Roo-Code)
- **⭐ Stars**: `24,298` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
- **🏷️ 标签**: `TypeScript` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 24,298）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 19. [micro/go-micro](https://github.com/micro/go-micro)
- **⭐ Stars**: `23,075` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Go`
...
- **✨ 核心功能与亮点**:
  ...
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 23,075）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 20. [HKUDS/AI-Trader](https://github.com/HKUDS/AI-Trader)
- **⭐ Stars**: `22,539` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `Python`
- **🏷️ 标签**: `Python` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 22,539）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 21. [getpaseo/paseo](https://github.com/getpaseo/paseo)
- **⭐ Stars**: `18,225` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 18,225）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 22. [Portkey-AI/gateway](https://github.com/Portkey-AI/gateway)
- **⭐ Stars**: `13,071` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 13,071）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 23. [codexu/note-gen](https://github.com/codexu/note-gen)
- **⭐ Stars**: `12,833` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 12,833）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **⭐ Stars**: `992` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
- **🏷️ 标签**: `TypeScript` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 精选实用工具（★ 992）：针对特定垂直场景设计，解决痛点需求，小巧精悍

### 31. [friuns2/codex-mobile](https://github.com/friuns2/codex-mobile)
- **⭐ Stars**: `939` | **二级分类**: 🤖 `智能体与工作流` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 精选实用工具（★ 939）：针对特定垂直场景设计，解决痛点需求，小巧精悍


## 2. 💬 大模型应用与客户端 (20 个项目)

### 1. [openclaw/openclaw](https://github.com/openclaw/openclaw)
- **⭐ Stars**: `390,350` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 390,350）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [router-for-me/CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI)
- **⭐ Stars**: `53,049` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Go`
...
- **✨ 核心功能与亮点**:
  ...
  - 极致性能：使用 Go 原生编写，单二进制分发，内存占用低且启动迅速
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 53,049）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 3. [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api)
- **⭐ Stars**: `42,545` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `Go`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 29,495）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 5. [mlc-ai/web-llm](https://github.com/mlc-ai/web-llm)
- **⭐ Stars**: `19,175` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 19,175）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **⭐ Stars**: `4,026` | **二级分类**: 💬 `大模型应用与客户端` | **语言**: `HTML`
- **🏷️ 标签**: `HTML`
...
- **✨ 核心功能与亮点**:
  ...
  - 技术栈友好：灵活适配多种技术环境，支持容器化与多平台部署
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 4,026）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃
...
- **⭐ Stars**: `37,007` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 JavaScript 打造，代码规范健壮，支持热重载与模块化组装
  - 标准化 API 支持：提供完善的 RESTful / gRPC 接口与清晰的接口文档规范
  - 超高人气（★ 37,007）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [JaidedAI/EasyOCR](https://github.com/JaidedAI/EasyOCR)
- **⭐ Stars**: `30,024` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 30,024）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **⭐ Stars**: `1,816` | **二级分类**: 🧠 `模型微调与底层工具` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - 标准化 API 支持：提供完善的 RESTful / gRPC 接口与清晰的接口文档规范
  - 热门高星（★ 1,816）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃
...
- **⭐ Stars**: `125,396` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 125,396）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 2. [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book)
- **⭐ Stars**: `50,528` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 50,528）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 3. [HBAI-Ltd/Toonflow-app](https://github.com/HBAI-Ltd/Toonflow-app)
- **⭐ Stars**: `15,962` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 TypeScript 打造，代码规范健壮，支持热重载与模块化组装
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 15,962）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 4. [chatfire-AI/huobao-drama](https://github.com/chatfire-AI/huobao-drama)
- **⭐ Stars**: `15,482` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `Vue`
- **🏷️ 标签**: `Vue`
...
- **✨ 核心功能与亮点**:
  ...
  - 技术栈友好：灵活适配多种技术环境，支持容器化与多平台部署
  - AI 智能体集成：支持多模型对接（OpenAI、Claude、本地模型等）与灵活 Prompt 编排
  - 超高人气（★ 12,672）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 6. [eternityspring/shuohao-skills](https://github.com/eternityspring/shuohao-skills)
- **⭐ Stars**: `3,750` | **二级分类**: 🎬 `AI 生成与短剧/多模态` | **语言**: `JavaScript`
- **🏷️ 标签**: `JavaScript` `LLM`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 JavaScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 3,750）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃


## 5. 🎙️ 语音识别与音频处理 (3 个项目)

### 1. [QwenAudio/CosyVoice](https://github.com/QwenAudio/CosyVoice)
- **⭐ Stars**: `23,750` | **二级分类**: 🎙️ `语音识别与音频处理` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 23,750）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **⭐ Stars**: `9,152` | **二级分类**: 🎙️ `语音识别与音频处理` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 9,152）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃
