...
> 本文档收录了 `ztj1993` 在 **数据处理与爬虫** 领域的精选 Star 项目，共划分 **3** 个二级细分子分类。

[← 返回知识库总览](../../README.md)

## 📑 本专题二级分类导航

- [🕷️ **网页爬虫与自动化** (8 个项目)](#1-网页爬虫与自动化)
- [📊 **数据解析与表格处理** (7 个项目)](#2-数据解析与表格处理)
- [📈 **数据可视化与报表** (1 个项目)](#3-数据可视化与报表)
...
- **⭐ Stars**: `95,617` | **二级分类**: 🕷️ `网页爬虫与自动化` | **语言**: `TypeScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 超高人气（★ 95,617）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **⭐ Stars**: `2,131` | **二级分类**: 🕷️ `网页爬虫与自动化` | **语言**: `JavaScript`
- **🏷️ 标签**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 类型安全与组件生态：基于 JavaScript 打造，代码规范健壮，支持热重载与模块化组装
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 2,131）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 8. [he426100/alipay-crawler](https://github.com/he426100/alipay-crawler)
- **⭐ Stars**: `51` | **二级分类**: 🕷️ `网页爬虫与自动化` | **语言**: `PHP`
- **🏷️ 标签**: `PHP` `alipay` `crawler` `selenium` `selenium-ide` `selenium-php`
- **📝 中文介绍**: 支付宝账单爬虫。
- **✨ 核心功能与亮点**:
  - 【网页爬虫与自动化】专精领域：专注解决 网页爬虫与自动化 场景下的核心需求与工程实践
...
- **🏷️ 标签**: `Python` `argument-parser` `config` `configuration` `configuration-file` `configuration-files`
