...
> 本文档收录了 `ztj1993` 在 **资源精选与学习指南** 领域的精选 Star 项目，共划分 **2** 个二级细分子分类。

[← 返回知识库总览](../../README.md)

## 📑 本专题二级分类导航

- [🌟 **Awesome 精选合集** (19 个项目)](#1-Awesome 精选合集)
- [📖 **学习路线与实战指南** (6 个项目)](#2-学习路线与实战指南)
...
- **⭐ Stars**: `129,195` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `JavaScript`
...
- **✨ 核心功能与亮点**:
  ...
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 129,195）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 5. [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
- **⭐ Stars**: `95,442` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Unknown`
- **🏷️ 标签**: `ai` `mcp`
...
- **✨ 核心功能与亮点**:
  ...
  - 技术栈友好：灵活适配多种技术环境，支持容器化与多平台部署
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 74,194）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 7. [slatedocs/slate](https://github.com/slatedocs/slate)
- **⭐ Stars**: `36,031` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Unknown`
...
- **✨ 核心功能与亮点**:
  ...
  - 技术栈友好：灵活适配多种技术环境，支持容器化与多平台部署
  - 标准化 API 支持：提供完善的 RESTful / gRPC 接口与清晰的接口文档规范
  - 超高人气（★ 36,031）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 8. [emirpasic/gods](https://github.com/emirpasic/gods)
- **⭐ Stars**: `17,460` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Go`
...
- **⭐ Stars**: `15,121` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Ruby`
...
- **✨ 核心功能与亮点**:
  ...
  - 技术栈友好：灵活适配多种技术环境，支持容器化与多平台部署
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 15,121）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 11. [humiaozuzu/awesome-flask](https://github.com/humiaozuzu/awesome-flask)
- **⭐ Stars**: `12,773` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Unknown`
...
- **✨ 核心功能与亮点**:
  ...
  - 技术栈友好：灵活适配多种技术环境，支持容器化与多平台部署
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 12,773）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 12. [Atarity/deploy-your-own-saas](https://github.com/Atarity/deploy-your-own-saas)
- **⭐ Stars**: `10,070` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 10,070）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **✨ 核心功能与亮点**:
  ...
  - 技术栈友好：灵活适配多种技术环境，支持容器化与多平台部署
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 3,948）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 15. [styfle/awesome-online-ide](https://github.com/styfle/awesome-online-ide)
- **⭐ Stars**: `3,531` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Unknown`
- **🏷️ 标签**: `awesome` `awesome-list` `ide` `list` `lists`
...
### 16. [kerlomz/captcha_trainer](https://github.com/kerlomz/captcha_trainer)
- **⭐ Stars**: `3,214` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Python`
- **🏷️ 标签**: `Python` `captcha-recognition` `ocr` `tensorflow` `tensorflow-tutorials`
...
- **⭐ Stars**: `2,823` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Jupyter Notebook`
...
- **⭐ Stars**: `2,425` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 热门高星（★ 2,425）：经过广泛社区验证的优秀开源方案，文档完善且维护活跃

### 19. [wqking/eventpy](https://github.com/wqking/eventpy)
- **⭐ Stars**: `48` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Python`
- **🏷️ 标签**: `Python` `callback` `event-dispatcher` `nested-events` `observe-pattern` `publish-subscribe`
...
- **⭐ Stars**: `102,316` | **二级分类**: 📖 `学习路线与实战指南` | **语言**: `Unknown`
...
- **✨ 核心功能与亮点**:
  ...
  - 技术栈友好：灵活适配多种技术环境，支持容器化与多平台部署
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 102,316）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 3. [scikit-learn/scikit-learn](https://github.com/scikit-learn/scikit-learn)
- **⭐ Stars**: `67,350` | **二级分类**: 📖 `学习路线与实战指南` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 67,350）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 4. [aymericdamien/TensorFlow-Examples](https://github.com/aymericdamien/TensorFlow-Examples)
- **⭐ Stars**: `43,743` | **二级分类**: 📖 `学习路线与实战指南` | **语言**: `Jupyter Notebook`
...
- **✨ 核心功能与亮点**:
  ...
  - 技术栈友好：灵活适配多种技术环境，支持容器化与多平台部署
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 43,743）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 5. [pypa/sampleproject](https://github.com/pypa/sampleproject)
- **⭐ Stars**: `5,240` | **二级分类**: 📖 `学习路线与实战指南` | **语言**: `Python`
- **🏷️ 标签**: `Python`
...
### 6. [WongMinHo/api-doc](https://github.com/WongMinHo/api-doc)
- **⭐ Stars**: `58` | **二级分类**: 📖 `学习路线与实战指南` | **语言**: `Unknown`
- **🏷️ 标签**: `api` `gitbook` `markdown` `API`
