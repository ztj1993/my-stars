...
[![Total Stars](https://img.shields.io/badge/Total_Stars-710-blue.svg?style=for-the-badge&logo=github)](https://github.com/ztj1993?tab=stars)
[![Primary Categories](https://img.shields.io/badge/Primary_Categories-10_Domains-brightgreen.svg?style=for-the-badge)](./docs/categories/)
[![Subcategories](https://img.shields.io/badge/Subcategories-35+_Classes-blueviolet.svg?style=for-the-badge)](./docs/categories/)
[![Interactive Web UI](https://img.shields.io/badge/Web_Dashboard-Open_HTML-purple.svg?style=for-the-badge)](./index.html)
...
| :--- | :---: | :---: | :--- | :--- |
| 🤖 **AI 与大模型** | `68` 个 | `9.6%` | • 智能体与工作流 (`31`)<br>• 大模型应用与客户端 (`20`)<br>• 模型微调与底层工具 (`8`)<br>• AI 生成与短剧/多模态 (`6`)<br>• 语音识别与音频处理 (`3`) | [📖 查看专题文档](./docs/categories/ai-llm.md) |
| 🎨 **前端与跨端开发** | `132` 个 | `18.6%` | • Vue 生态与组件库 (`58`)<br>• 跨端与桌面应用 (`26`)<br>• 前端工程化与样式工具 (`26`)<br>• React 与全栈框架 (`15`)<br>• 浏览器扩展与插件 (`7`) | [📖 查看专题文档](./docs/categories/frontend.md) |
| ⚙️ **后端架构与微服务** | `102` 个 | `14.4%` | • Go 后端与微服务 (`37`)<br>• PHP 与快速开发 (`23`)<br>• Python 后端与 API (`19`)<br>• Node.js / Java 框架 (`18`)<br>• API 网关与通信协议 (`5`) | [📖 查看专题文档](./docs/categories/backend.md) |
| ☁️ **DevOps 与云原生** | `155` 个 | `21.8%` | • Docker 与容器管理 (`80`)<br>• 网络代理与内网穿透 (`23`)<br>• 软路由与网络系统 (`20`)<br>• CI/CD 与运维监控 (`19`)<br>• Kubernetes 与编排 (`13`) | [📖 查看专题文档](./docs/categories/devops.md) |
| 🛠️ **效率工具与 CLI** | `113` 个 | `15.9%` | • 账号管理与开发提效 (`43`)<br>• 终端工具与 TUI (`38`)<br>• 系统增强与桌面工具 (`16`)<br>• 开发规范与代码管理 (`10`)<br>• 下载器与传输工具 (`6`) | [📖 查看专题文档](./docs/categories/cli-tools.md) |
| 🕷️ **数据处理与爬虫** | `16` 个 | `2.3%` | • 网页爬虫与自动化 (`8`)<br>• 数据解析与表格处理 (`7`)<br>• 数据可视化与报表 (`1`) | [📖 查看专题文档](./docs/categories/data-scraping.md) |
| 🗄️ **数据库与存储** | `76` 个 | `10.7%` | • 关系型与 NoSQL 数据库 (`44`)<br>• 数据库客户端与管理工具 (`10`)<br>• ORM 与数据访问层 (`10`)<br>• 对象存储与备份同步 (`7`)<br>• 向量数据库与搜索引擎 (`5`) | [📖 查看专题文档](./docs/categories/database.md) |
| 🛡️ **网络安全与逆向** | `12` 个 | `1.7%` | • 网络安全攻防与审计 (`8`)<br>• 漏洞扫描与渗透测试 (`2`)<br>• 逆向工程与调试 (`2`) | [📖 查看专题文档](./docs/categories/security.md) |
| 🎬 **影音多媒体与图形** | `11` 个 | `1.5%` | • 流媒体与播放器 (`5`)<br>• 音视频处理与转码 (`4`)<br>• 图形渲染与 3D (`2`) | [📖 查看专题文档](./docs/categories/media.md) |
| 📚 **资源精选与学习指南** | `25` 个 | `3.5%` | • Awesome 精选合集 (`19`)<br>• 学习路线与实战指南 (`6`) | [📖 查看专题文档](./docs/categories/learning-resources.md) |
...
- **⭐ Stars**: `482,104` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 超高人气（★ 482,104）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **⭐ Stars**: `371,167` | **二级分类**: 📖 `学习路线与实战指南` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 超高人气（★ 371,167）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验

### 4. [vinta/awesome-python](https://github.com/vinta/awesome-python)
- **⭐ Stars**: `322,178` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 322,178）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
### 8. [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh)
...
- **⭐ Stars**: `177,990` | **二级分类**: 🌟 `Awesome 精选合集` | **语言**: `Python`
...
- **✨ 核心功能与亮点**:
  ...
  - 生态丰富：依托完善的 Python 开源生态，API 接口设计简洁且易于二次扩展
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 177,990）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
- **⭐ Stars**: `150,154` | **二级分类**: 🎞️ `音视频处理与转码` | **语言**: `C`
...
- **✨ 核心功能与亮点**:
  ...
  - 社区活跃与高星支持：在 GitHub 拥有良好社区口碑，持续维护并拥有完整文档
  - 超高人气（★ 146,221）：业界知名标杆项目，拥有庞大社区活跃度与广泛生产实战检验
...
<sub>*知识库构建时间: 2026-09-22 03:17:48*</sub>